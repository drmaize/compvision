datapath = ['/mnt/data27/wisser/drmaize/image_data/e',experiment,'/microimages/reconstructed/HS/']; %datapath
samp = ['e',experiment,'p',plt,'w',wl,'x20_',timestamp]; %sample name

fname = [datapath,samp,'rl001.ome.tif']; %filename
fsurfname = [datapath,'surfacemap/',samp,'_topsurface_optimized1.txt']; %file name to save surface location
isurfname = [datapath,'surfacemap/',samp,'_topsurface_image1.png']; %surface image name
