 ...
 * drop targets.
 */
public class GenericDialogPlus extends GenericDialog1 implements KeyListener {
	...
	public void addStringField(String label, String defaultString, int columns) {
		...
		/*TextField text = new TextField(strings.lastElement());
