...
public class Stitching_Grid implements PlugIn
{
	...
	public static boolean defaultIgnoreZStage = true;
	...
	public void run( String arg0 ) 
	{
    	...
    	final ArrayList<ImagePlusTimePoint> optimized = CollectionStitchingImgLib.stitchCollection(elements, params);//CollectionStitchingImgLib.stitchCollection( elements, params, gridSizeX, gridSizeY );
		...
		if ( params.fusionMethod != CommonFunctions.fusionMethodListGrid.length - 1 )
		{
			...
			if ( is32bit )
				imp = Fusion.fuse( new FloatType(), images, models, params.dimensionality, params.subpixelAccuracy, params.fusionMethod, params.outputDirectory, noOverlap, gridSizeX, gridSizeY );
			else if ( is16bit )
				imp = Fusion.fuse( new UnsignedShortType(), images, models, params.dimensionality, params.subpixelAccuracy, params.fusionMethod, params.outputDirectory, noOverlap, gridSizeX, gridSizeY );
			else if ( is8bit )
				imp = Fusion.fuse( new UnsignedByteType(), images, models, params.dimensionality, params.subpixelAccuracy, params.fusionMethod, params.outputDirectory, noOverlap, gridSizeX, gridSizeY );
			else
